...
public class OlympaCorePermissions {
	...
	public static final OlympaPermission DISCORD_COMMAND_MANAGE = new OlympaBungeePermission(OlympaGroup.RESP_TECH, true);
	...
	public static final OlympaPermission MAINTENANCE_COMMAND = new OlympaBungeePermission(OlympaGroup.RESP_TECH);
	...
	public static final OlympaPermission BUNGEE_REDIS_COMMAND = new OlympaBungeePermission(OlympaGroup.RESP_TECH);
	...
	public static final OlympaPermission BAN_FORCEKICK_COMMAND = new OlympaBungeePermission(OlympaGroup.ASSISTANT);
	...
	public static final OlympaPermission BAN_BANIPDEF_COMMAND = new OlympaBungeePermission(OlympaGroup.RESP_TECH);

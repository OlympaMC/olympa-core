...
public class ListServerCommand extends BungeeCommand {
	...
	public void onCommand(CommandSender sender, String[] args) {
		...
		MonitorServers.getServers().stream().sorted((o1, o2) -> Integer.compare(o1.getStatus().getId(), o2.getStatus().getId())).forEach(serverInfo -> {
			...
			if (serverInfo.getFirstVersion().equals(serverInfo.getLastVersion()))
				sb.add(serverInfo.getFirstVersion() + "-" + serverInfo.getLastVersion());
			else
				sb.add(serverInfo.getFirstVersion());

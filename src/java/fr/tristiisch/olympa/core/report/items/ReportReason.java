...
public enum ReportReason {
	...
	CHAT(1, "Chat abusif", new OlympaItemBuild(Material.BOOK_AND_QUILL, "&7Chat abusif").lore("", "&eSpam, Insulte, Provocations, Publicité ...")),
	CHEAT_AURA(2, "Cheat Combat", new OlympaItemBuild(Material.GOLD_SWORD, "&7Cheat Combat").lore("", "&eKillAura, Aimbot, TriggerBot, AutoClick ...")),
